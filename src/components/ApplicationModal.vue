  ...
  <div v-if="showModal" class="application-modal" @click="closeModal">
    <div class="modal-content" @click.stop>
      <div v-if="!applicationSubmitted">
        ...
        <p>
          You wish to join our {{ selectedRole }} ranks? The ritual demands
          commitment.
        </p>
        <div class="form-group">
          ...
          <textarea
            ...
            placeholder="Tell us of your dark talents..."
          ></textarea>
        </div>
        <div class="modal-actions">
          <button class="submit-application" @click="submitApplication">
            Submit Application
          </button>
      ...
      <div v-else>
        ...
        <p>
          Your application has been cast into the void. The council will
          deliberate.
        </p>
...
export default {
  ...
  setup() {
    ...
    const applicationSubmitted = computed(
      () => store.applicationSubmitted.value
    )
